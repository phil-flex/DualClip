...
public class Languages {
	...
	private static final long serialVersionUID = -731684022613105122L;


	public static String getLanguage(String idioma){
		HashMap<String, Language> idiomas;
		idiomas = idiomasHashMap();

		return (idiomas.get(idioma).toString());
	}
	...
	public static HashMap<String, Language> idiomasHashMap() {
		...
		/* TODO IDIOMAS COMENTADOS INCOMPATIBLES, SOLO PRESENTES LOS COMUNES */
...
//        idiomas.put("Georgian", Language.GEORGIAN);
        ...
        idiomas.put("Hatian_creole", Language.HAITIAN_CREOLE);		// Only Microsoft
...
//        idiomas.put("Swahili", Language.SWAHILI);
        ...
        idiomas.put("Ukranian", Language.UKRAINIAN);
